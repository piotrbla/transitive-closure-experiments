...
void computeDYN2Perfect(int** table, int n, int *seq) {
  ...
  for (int c0 = 1; c0 <= floord(n - 2, 10) + 1; c0 += 1) {
    #pragma omp parallel for
    for (int c1 = max(-((n + 8) / 10), -c0 - (c0 + 2) / 3 + 1); c1 <= -c0; c1 += 1) {
      for (int c4 = max(max(-n + 2, 40 * c0 + 40 * c1 - 39), 10 * c1 + 1); c4 <= 40 * c0 + 40 * c1; c4 += 1) {
        for (int c5 = max(-10 * c1 - 9, -c4 + 1); c5 <= min(n - 1, -10 * c1); c5 += 1) {
          for (int c7 = -c4; c7 < c5; c7 += 1) {
            S[-c4][c5] = max_score(S[-c4][c7] + S[c7 + 1][c5], S[-c4][c5]);
          }
          S[-c4][c5] = max_score(S[-c4][c5], S[-c4 + 1][c5 - 1] + match(seq[-c4], seq[c5]));
...
void computeDYN3ImperfA(int** table, int n, int *seq) {
  ...
  for (int c0 = 1; c0 <= floord(n - 2, 16) + 1; c0 += 1) {
    #pragma omp parallel for
    for (int c1 = max(max(-((n + 14) / 16), -c0 - (n + 50) / 52 + 1), -c0 - (4 * c0 + 8) / 9 + 1); c1 <= -c0; c1 += 1) {
      for (int c4 = max(max(-n + 2, 52 * c0 + 52 * c1 - 51), 16 * c1 + 1); c4 <= 52 * c0 + 52 * c1; c4 += 1) {
        for (int c5 = max(-16 * c1 - 15, -c4 + 1); c5 <= min(n - 1, -16 * c1); c5 += 1) {
          for (int c7 = -c4; c7 < c5; c7 += 1) {
            S[-c4][c5] = max_score(S[-c4][c7] + S[c7 + 1][c5], S[-c4][c5]);
          }
          S[-c4][c5] = max_score(S[-c4][c5], S[-c4 + 1][c5 - 1] + match(seq[-c4], seq[c5]));
...
void computeDYN4ImperfB(int** table, int n, int *seq) {
  ...
  for (int c0 = 1; c0 <= floord(n - 2, 30) + 1; c0 += 1) {
    #pragma omp parallel for
    for (int c1 = max(max(-((n + 28) / 30), -c0 - (n + 52) / 54 + 1), -2 * c0 - (c0 + 3) / 4 + 1); c1 <= -c0; c1 += 1) {
      for (int c4 = max(max(-n + 2, 54 * c0 + 54 * c1 - 53), 30 * c1 + 1); c4 <= 54 * c0 + 54 * c1; c4 += 1) {
        for (int c5 = max(-30 * c1 - 29, -c4 + 1); c5 <= min(n - 1, -30 * c1); c5 += 1) {
          for (int c7 = -c4; c7 < c5; c7 += 1) {
            S[-c4][c5] = max_score(S[-c4][c7] + S[c7 + 1][c5], S[-c4][c5]);
          }
          S[-c4][c5] = max_score(S[-c4][c5], S[-c4 + 1][c5 - 1] + match(seq[-c4], seq[c5]));
